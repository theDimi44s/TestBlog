...
require ("/OpenServer/domains/testphpsite.com/includes/config.php");
...
<body>
  ...
  <div id="wrapper">
    ...
    <?php include "/OpenServer/domains/testphpsite.com/includes/header.php"; ?>
              ...
              <div class="block__content">
                ...
                <?php
                  ...
                  <article class="article">
                    ...
                    <div class="article__image" style="background-image: url(../img/<?php echo $art['img']; ?> );"></div>
                    
                    <div class="article__info">

                      <a href="/article.php?id=<?php $art['id']; ?> "> <?php echo $art['title']; ?></a>
